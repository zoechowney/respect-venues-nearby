...
import { LogOut, Edit, Clock, CheckCircle, AlertTriangle, MessageSquare } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-light-blue via-trans-white to-trans-pink/10">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-brand-navy/70">Manage your venue information, track applications, and respond to reviews</p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-8">
            ...
            {applications.length > 0 && (
              <div>
                <h2 className="text-xl font-semibold text-brand-navy mb-4">Application Status</h2>
          ...
          <TabsContent value="reviews">
            {venueOwner?.id && <VenueOwnerReviews venueOwnerId={venueOwner.id} />}
          </TabsContent>
        </Tabs>
      </div>
